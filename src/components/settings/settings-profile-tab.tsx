...
export function SettingsProfileTab() {
  return (
    <div>
      ...
      <div className="overflow-x-auto rounded-xl border border-outline bg-white">
        <table className="w-full min-w-200 border-collapse text-left text-sm">
          ...
          <tbody>
            <tr>
              <td className="px-4 py-5 font-medium border-r border-outline text-black underline underline-offset-2">
                {profile.employeeId}
              </td>
              <td className="px-4 py-5 border-r border-outline text-primary-text">{profile.name}</td>
              <td className="px-4 py-5 border-r border-outline text-zinc-500">{profile.email}</td>
              <td className="px-4 py-5 border-r border-outline text-zinc-500">{profile.phoneNumber}</td>
              <td className="px-4 py-5 border-r border-outline text-zinc-500">{profile.department}</td>
              <td className="px-4 py-5 border-r border-outline text-zinc-500">{profile.role}</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <div className="mt-4 border rounded-xl border-outline py-4 bg-surface-subtle">
      <div>
        <p className="px-4 mb-2 text-sm font-medium text-zinc-500">Date Joined</p>
      </div>
      <div className="bg-white h-16 rounded-b-xl"> 
        <hr className="my-2 border-t border-outline w-full" />
