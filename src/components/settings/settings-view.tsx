    ...
    <div>
      ...
      <header className="flex flex-wrap items-center gap-4">
        ...
        <div className="ml-auto shrink-0">
          <button
            type="button"
            className="inline-flex h-9 items-center gap-1.5 rounded-full border border-zinc-200 bg-white px-4 text-sm font-semibold text-primary-text transition-colors hover:bg-[#F9FAFB]"
          >
            Action
